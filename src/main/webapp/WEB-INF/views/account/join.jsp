...
<div id="join-form" class="join-form">
	...
	<form:form commandName="member" enctype="multipart/form-data">
		...
		<div class="md-form">
			<a id="check-btn" class="btn-floating btn btn-primary btn-sm ">중복
				체크</a> <span id="check-message"></span>
		</div>
		...
		<div class="mb-3">
			<label for="avata">아바타 이미지</label> <input type="file" name="avata" />
		</div>
		<div class="md-form">
		...
		<div class="md-form">
			...
			<form:input path="cellPhone" class="form-control" required="required" />
		</div>
