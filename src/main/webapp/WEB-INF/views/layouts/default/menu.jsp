...
<nav class="navbar navbar-expand-lg navbar-dark primary-color">
    ...
    <!-- Navbar brand -->
    <a class="navbar-brand" href="${root}">Butter</a>
    ...
    <div class="collapse navbar-collapse" id="basicExampleNav">
        ...
        <ul class="navbar-nav mr-auto">
			<li class="nav-item"><a class="nav-link" href="${root}gallery/lightbox">
				<i class="fa fa-images"></i> Gallery</a></li>
        ...
        <ul class="navbar-nav">
			<c:choose>
				...
				<li class="nav-item">
					<a class="nav-link" href="${root}login"><i class="fa fa-sign-in-alt"></i> 로그인</a> 
				</li>
				<li class="nav-item">
					<a class="nav-link" href="${root}join"><i class="fa fa-user-plus"></i> 회원가입</a>
				</li>			
				</c:when>
				<c:otherwise>
					<li class="nav-item">
						<a class="nav-link" href="${root}member/profile">
							<img src="${root}member/avata?userId=${USER.userId}"
								class="rounded-circle avata-small" >
							${USER.userId}
						</a>
					</li>
					<li class="nav-item">
					...
					<li class="nav-item"> 
						<a class="nav-link" href="${root}logout"><i class="fa fa-sign-out-alt"></i> 로그아웃</a>
					</li>
